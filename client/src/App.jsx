...
import MusicEntryEdit from './Pages/MusicEntryEdit';
      ...
      <ApolloProvider client={client}>
        <Container className='min-width'>
          ...
          <Routes>
            ...
            <Route
              path='/'
              element={<ProtectedRoute component={Music} user={user} />}
            />
            {/* Protected Journal Entry Edit Route */}
            <Route
              path='/music/edit/:musicEntryId'
              element={
                <ProtectedRoute component={MusicEntryEdit} user={user} />
              }
            />
            {/* 404 Page */}
